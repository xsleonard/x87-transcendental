#!/bin/sh
# Compiler-free h320 third narrow shared-sine fractional capture.
set -eu
cd "$(dirname "$0")"
...
INPUT=inputs/constraint_trig_narrow_sine_fraction3_h320.txt
OUT=${1:-trig-narrow-sine-fraction3-out}
mkdir -p "$OUT"
