...
# x rn/rd/ru.  Expected (2026-08-18 baseline): cos 4/4/4, sin 5/3/5
# per rn/rd/ru — TOTAL 25/48,000,000, all +-1 ulp (register B9: 4
...
for insn in ("cos","sin"):
    for mode in ("rn","rd","ru"):
        ...
        tot += bad
print("TOTAL:", tot, "/ 48000000  (baseline 25)")
PYEOF
