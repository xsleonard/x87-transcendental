...
def main():
    ...
    evidence["experiments/h1622_fixed_candidate_scanner.c"] = digest(root / "experiments/h1622_fixed_candidate_scanner.c")
    ...
    source = prefix + source.replace(include, OBSERVER) + '\n#undef main\n' + (root / "experiments/h1622_fixed_candidate_scanner.c").read_text()
    ...
    result = {"experiment": "h1622_fixed_candidate_challenge_bank", "capture_state": "SOFTWARE_ONLY_NOT_FROZEN",
