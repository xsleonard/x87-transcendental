...
typedef struct { uint16_t se; uint64_t sig; } x87_fpatan_value;
typedef enum { X87_FPATAN_RN=0,X87_FPATAN_RD=1,X87_FPATAN_RU=2,X87_FPATAN_RZ=3 } x87_fpatan_round;
typedef struct {
...
x87_fpatan_error x87_fpatan_evaluate(const x87_fpatan *context,
    ...
    unsigned precision_control,x87_fpatan_result *result);
