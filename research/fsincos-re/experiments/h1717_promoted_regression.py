...
HEADER = '4eeb671562969e39b334923cbf41a40cb86f2a5ecb3dbad23de320be315b9a5d'
...
def main():
    ...
    if a.instruction=='paired':
        ...
        old=root/'tmp/ledger33/current/h1710_all_retained_census'
        assert digest(old/'report.json')=='810d3ed89e828d3c4178230e7c5f3307f75de43abf300491eabcfa7d0e78c87d'
    ...
    report=dict(experiment='h1717_promoted_regression',instruction=a.instruction,
