#!/bin/sh
# H1694: 624 reviewed fresh standalone tuples. Never restart a partial run.
# The old H1641 pair is excluded; new state fields do not exempt old tuples.
set -eu
[ "$#" -eq 1 ] || exit 2
BIN=$1
...
echo "H1694_CAPTURE_COMPLETE tuples=$EXPECTED retries=0"
