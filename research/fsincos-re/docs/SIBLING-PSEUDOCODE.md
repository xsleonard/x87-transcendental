...
The canonical program is [sibling_reference.py](sibling_reference.py), using
...
source. The literal data is [sibling-constants.json](sibling-constants.json).
...
The [F2XM1 integration record](../paper/evidence/f2xm1-integration.json)
...
observations. The [current H257 receipt](../paper/evidence/f2xm1-current-replay.json)
and [FPTAN receipt](../paper/evidence/fptan-pseudocode-replay.json) bind the
